...
The [project](https://github.com/gdantasdev/gdantas.dev) built using the following tools & frameworks:
...
![A screenshot of gdantas.dev](/blog/hello_world/screenshot.png 'A screenshot of gdantas.dev')
