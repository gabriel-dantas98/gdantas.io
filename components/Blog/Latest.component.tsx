...
export function Latest({ frontmatter }: LatestProps) {
	...
	return (
        <Link aria-label={ariaLabel} href={href} className="flex flex-col lg:flex-row mt-12 bg-white bg-opacity-75 dark:(bg-gray-900 bg-opacity-75 border-gray-500) backdrop-filter backdrop-blur-sm rounded-2xl hover:shadow-xl cursor-pointer border-2 border-gray-100 transform motion-safe:hover:-translate-y-1 default-transition default-focus">
