...
export function ProjectsPage({ stringifiedProjects, locale = 'pt' }: ProjectProps & { locale?: 'pt' | 'en' }) {
	return (
		<I18nProvider locale={locale}>
			<ProjectsPageInner stringifiedProjects={stringifiedProjects} />
		</I18nProvider>
	);
}
		...
		<OperatorPage
			...
			<div ref={ref}>
				...
				<div style={{ marginTop: 28, fontSize: 13 }}>
					<Prompt path="~">
						{t('projects.footerPromptPre')}{' '}
						<span style={{ color: OP.amber }}>
							{projects.length} {t('projects.footerPods')}
						</span>
					</Prompt>
				</div>
			</div>
